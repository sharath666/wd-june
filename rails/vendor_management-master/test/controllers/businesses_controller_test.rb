...
class BusinessesControllerTest < ActionController::TestCase
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post :create, business: { business_type: @business.business_type, name: @business.name, tin_number: @business.tin_number }
    end
  ...
  test "should update business" do
    patch :update, id: @business, business: { business_type: @business.business_type, name: @business.name, tin_number: @business.tin_number }
    assert_redirected_to business_path(assigns(:business))
  end
